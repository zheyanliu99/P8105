...
Variable rank\_precent is calulated by rank/count. Rank is the name
...
The above table is the orignial longer table, rank\_precent is
calculated with the same method. The difference of this wider table with
that of “Olivia” is that now it has two rows variable
(childs\_first\_name and ethnicity)
